...
//   const currentSeed = null;
//   const currentRandom = null;
//   const noiseGenerator = null;
//   const _nextGaussian = null;
//   const _hasNextGaussian = false;
...
//   function noise4D(x: number, y: number, z: number, w: number, frequency: number, amplitude: number) {
