...
// export const lineSegmentTree = function (paths: (PathType | number[][])[]) {
//   return group(
...
//         p0: PointType,
//         p1 = path[0],
//         children: (TreeNode | TreeLeaf)[] = new Array(n - 1);

//       while (++i < n) {
//         (p0 = p1), (p1 = path[i]);
//         children[i - 1] = new TreeLeaf([p0, p1]);
//       }
...
// function group(children: (TreeNode | TreeLeaf)[]) {
//   var i0, i1, n0, n1, child0, child1, children1;
...
//       children1[i1] = new TreeNode(child0, child1);
//     }
...
//   constructor(paths: (PathType | number[][])[]) {
//     this.paths = paths;
//     this.root = group(
//       paths.map(function (path) {
//         let i = 0,
...
//   } while (
//     (candidate = heap.pop()) &&
//     (distance = candidate.distance) <= minDistance
//   );
...
//   coordinates: LineType;
//   extent: [PointType, PointType];
//   constructor([point0, point1]: LineType) {
//     this.coordinates = [point0, point1];
//     this.extent = [
//       [Math.min(point0[0], point1[0]), Math.min(point0[1], point1[1])],
//       [Math.max(point0[0], point1[0]), Math.max(point0[1], point1[1])],
...
//   intersections([p1, p2]) {
//     return intersectLeaf(this, p1, p2) ? [this] : [];
//   }

//   intersectLeaf(leaf, q, q2) {
...
//   return Math.sqrt(
//     pointDistance(c, t <= 0 ? a : t >= 1 ? b : [a[0] + t * dx, a[1] + t * dy])
//   );
// }
